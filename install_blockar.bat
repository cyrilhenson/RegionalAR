...
title BlockAR Desktop - University Installer
color 0B

echo.
echo  ================================================================
echo    BlockAR Desktop - Full Installation
...
cd /d "%~dp0"
set "INSTALL_DIR=%~dp0"
set "LAUNCHER=%INSTALL_DIR%BlockAR.bat"
...
echo Set shortcut = ws.CreateShortcut^(ws.SpecialFolders^("Desktop"^) ^& "\BlockAR Desktop.lnk"^)
echo shortcut.TargetPath = "%LAUNCHER%"
echo shortcut.WorkingDirectory = "%INSTALL_DIR%"
echo shortcut.Description = "BlockAR - DICOM Volume AR for Quest 3"
...
echo    Shortcut:  Desktop - "BlockAR Desktop"
echo.
echo    To run:    Double-click "BlockAR Desktop" on your desktop
echo               or run BlockAR.bat from this folder.
echo.
